  ...
  return (
    <div className="flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10">
      ...
      <button
        ...
        className="bg-blue-50 text-gray-600 px-12 py-3 rounded-full mt-10 focus:outline-none hover:bg-blue-100 transition-all duration-300"
      >
        More
      </button>
    </div>
